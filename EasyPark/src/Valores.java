...
public class Valores {
    ...
    public String toString() {
        ...
        sb.append("--\t\tValores\t\t--\n").append("- Hora: ").append(getValorHora()).append("\n");
        if (this.fracaoQuinze != 0)
                sb.append("- Fracao 15 minutos: ").append(getFracaoQuinze()).append("\n");
        if (this.valorDiaria != 0)
                sb.append("- Diaria: ").append(getValorDiaria()).append("\n");
        if (this.valorMensal != 0)
                sb.append("- Mensal: ").append(getValorMensal()).append("\n");
        if (this.perNoite != 0)
                sb.append("- Pernoite: ").append(getPerNoite());
        return sb.toString();
    }
}
